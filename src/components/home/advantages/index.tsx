	...
	const data = [
		{
			...
			desc: "Квалифицированные специалисты с зарубежным опытом гарантируют высокое качество своих изделий.",
		},
		{
			icon: icon2,
			title: "Собственные технологии",
			desc: "Собственный цех и современное оборудование для сборки изделий обеспечивают скорость и качество.",
		},
		{
			icon: icon3,
			title: "Надежные материалы",
			desc: "Используем только высококачественные материалы с гарантией до 30 лет.",
		},
	];
				...
				<Flex
					...
					<Flex
						...
						<Text
							...
							fontSize={18}
							fontWeight={400}>
							Мы объединяем опыт квалифицированных специалистов и собственное
							производство, оснащенное современным швейцарским оборудованием.
						</Text>
						<Flex
