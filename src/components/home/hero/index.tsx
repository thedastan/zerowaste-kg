				...
				<Box className="container2">
					<Flex
						...
						<Text
							...
							fontSize={18}
							fontWeight={400}>
							Наша многопрофильная компания ОсОО «Зеро Вест» занимается
							проектированием и строительством комплексных и инженерных
							сооружений с использованием современных зарубежных технологий.
						</Text>
					</Flex>
				</Box>
				<Box py={10}>
