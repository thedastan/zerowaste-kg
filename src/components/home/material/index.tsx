	...
	return (
		<Box py={{ base:20, md: 40 }}>
            ...
            <Image style={{width:"100%", height:"100%"}} src={img} alt="img" />
						...
						<Box data-aos="fade-up-right"  display={{ base: "none", md: "flex" }} mt={7} gap={2} flexWrap="wrap">
							{data.map((el, index) => (
								<Box
                mt={1}
						...
						<Box  display={{ base: "flex", md: "none" }} mt={7} gap={2} flexWrap="wrap">
							{data2.map((el, index) => (
								<Box
                mt={1}
									p={{ base: "10px 10px", md: "10px 15px" }}
          ...
          <Box  data-aos="zoom-out-left" display={{ base: "none", md: "flex" }} mt={{ base:12, md: 0 }}  w={{ base: "100%", md: "550px" }} h={{ base: "330px", md: "500px" }}>
            <Image style={{width:"100%", height:"100%"}} src={img} alt="img" />
          </Box>
				</Flex>
			</div>
